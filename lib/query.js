...
Query.prototype.facet = function(options){
   ...
   if(options.contains){
      this.parameters.push('facet.contains=' + encodeURIComponent(options.contains))
   } 
   if(options.sort){
...
Query.prototype.jsonFacet = function(jsonFacet){
   var self = this;
      this.parameters.push('json.facet='+encodeURIComponent(JSON.stringify(jsonFacet)) );
   return self;
}
